...
const zeroToStreepje = function (waarde) {
	if (waarde == 0) {
		return '----';
	} else {
		return waarde;
...
const showLocations = function (jsonObjectMetContainer) {
	try {
		...
		for (const locatie of arrLocations) {
            ...
            `;
			console.log(htmlPopupContent, coordinates)
...
// const showZuil = function(id){
// 	const alleLocaties = document.querySelectorAll(".js-locatie");
// 	for(const eenLocatie of alleLocaties){
// 		eenLocatie.classList.remove("c-locatie--active");
// 		if(eenLocatie.dataset.id == id){
// 			eenLocatie.classList.add("c-locatie--active")
// 		}
// 	}
// }
